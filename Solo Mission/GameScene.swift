...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    override func update(_ currentTime: TimeInterval) {
        ...
        // Make sure you never have more than 5 bullets (rockets)
        print("bulletNumber: \(bulletNumber) from update")
        if bulletNumber >= 6 {
            bulletNumber = 5
        }
    }
    ...
    func addBullet() {
        ...
        print("bulletNumber: \(bulletNumber) from addBullet")
    }
    
    func firedbullet(){
        bulletNumber -= 1
        bulletLabel.text = "Rockets: \(bulletNumber)"
        print("bulletNumber: \(bulletNumber) from firedBullet")
    }
